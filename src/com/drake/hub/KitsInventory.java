...
public class KitsInventory {
	...
	public static Inventory jeux = Bukkit.createInventory(null, 54,ChatColor.DARK_RED+ ""+ChatColor.BOLD+"Liste des jeux !");
	static {
	...
	public static Inventory cosmetiques = Bukkit.createInventory(null, 54,ChatColor.DARK_PURPLE+ ""+ChatColor.BOLD+"Liste des cosmétiques !");
	static {
